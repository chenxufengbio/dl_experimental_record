...
参考文献：Deep Learning for Genomics: A Concise Overview 3.1Model Interpretation
...
![image-20210322175439956](C:\Users\DELL\AppData\Roaming\Typora\typora-user-images\image-20210322175439956.png)
...
![image-20210322190357603](C:\Users\DELL\AppData\Roaming\Typora\typora-user-images\image-20210322190357603.png)
...
方法七：[Deepmotif](file:///D:/Zotero%E6%96%87%E7%8C%AE/Deepmotif.pdf)
...
![](C:\Users\DELL\AppData\Roaming\Typora\typora-user-images\image-20210406202019253.png)



1.500bp的长度中提取多个motif，多个TF结合位点

2.加入chromatin accessibility 信息，提取开放染色质区域的motif
...
利用Transformer的self-attention机制



![](C:\Users\DELL\AppData\Roaming\Typora\typora-user-images\image-20210422115919537.png)

```
head -50000 dataset_all_90w >> dataset_rice_10w.csv
tail -50000 dataset_all_90w >> dataset_rice_10w.csv
awk -v OFS="\t" '{if ($3 == 5) $3 = 0}1' dataset_rice_10w.csv > dataset3.csv
